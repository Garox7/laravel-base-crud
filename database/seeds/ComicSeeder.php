...
class ComicSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($comicsBook as $book) {
            $comic = new Comic();
            $comic->title = $book['title'];
            $comic->description = $book['description'];
            $comic->thumb = $book['thumb'];
            $comic->price = $book['price'];
            $comic->series = $book['series'];
            $comic->sale_date = $book['sale_date'];
            $comic->graphinc_novel = $book['type'];
            $comic->save();
        }
    }
}
